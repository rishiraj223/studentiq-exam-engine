  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <main className="flex-grow pt-24 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
        <Link href="/" className="inline-flex items-center text-sm font-medium text-slate-600 hover:text-slate-900 transition-colors mb-8">
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
            ...
            <div className="space-y-6 mb-12">
              {[
                ...
                <div key={i} className="flex items-start">
                  ...
                  <span className="text-lg font-medium text-slate-900">{highlight}</span>
                </div>
              ))}
            </div>

            <div className="bg-white border border-slate-200 shadow-sm rounded-2xl p-6 sm:p-8 flex items-center gap-6">
              <Logo size="lg" showText={false} />
              <div>
                <h4 className="text-lg font-semibold text-slate-900 mb-1">Trusted Platform</h4>
          ...
          {/* Right Side - Form */}
          <div className="bg-white border border-slate-200 rounded-3xl p-6 sm:p-10 shadow-xl backdrop-blur-sm">
            <h2 className="text-2xl font-bold text-slate-900 mb-8">Fill in your details</h2>
            <DemoForm />
          </div>
        </div>
      </main>
